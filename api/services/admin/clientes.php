    ...
    if (isset($_SESSION['idAdministrador'])) {
        ...
        switch ($_GET['action']) {
            ...
            /*case 'createRow':
                ...
                if (
                    !$clientes->setNombre($_POST['nombreAdministrador']) or
                    !$clientes->setApellido($_POST['apellidoAdministrador']) or
                    !$clientes->setCorreo($_POST['correoAdministrador']) or
                    !$clientes->setAlias($_POST['aliasAdministrador']) or
                    !$clientes->setClave($_POST['claveAdministrador'])
                ) {
